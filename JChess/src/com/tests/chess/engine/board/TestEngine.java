...
public class TestEngine {
        ...
        public void kiwiPeteDepth1() {
            ...
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 48L);
        }
        ...
        public void kiwiPeteDepth2() {
            ...
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 2039L);
        }
        ...
        public void kiwiPeteDepth3() {
            ...
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 97862L);
        }
        ...
        public void kiwiPeteDepth4() {
            ...
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 4085603L);
        }
        ...
        public void kiwiPeteDepth5() {
            ...
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 193690690L);
        }
        ...
        public void testPosition3Depth1() {
            ...
            final MoveStrategy minMax = new MiniMax(1);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 14L);
        }
        ...
        public void testPosition3Depth2() {
            ...
            final MoveStrategy minMax = new MiniMax(2);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 191L);
        }
        ...
        public void testPosition3Depth3() {
            ...
            final MoveStrategy minMax = new MiniMax(3);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 2812L);
        }
        ...
        public void testPosition3Depth4() {
            ...
            final MoveStrategy minMax = new MiniMax(4);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 43238L);
        }
        ...
        public void testPosition3Depth5() {
            ...
            final MoveStrategy minMax = new MiniMax(5);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 674624L);
        }
        ...
        public void testPosition4Depth1() {
            ...
            final MoveStrategy minMax = new MiniMax(1);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 6L);
        }
        ...
        public void testPosition4Depth2() {
            ...
            final MoveStrategy minMax = new MiniMax(2);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 264L);
        }
        ...
        public void testPosition4Depth3() {
            ...
            final MoveStrategy minMax = new MiniMax(3);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 9467L);
        }
        ...
        public void testPosition4Depth4() {
            ...
            final MoveStrategy minMax = new MiniMax(4);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 422333L);
        }
        ...
        public void testPosition4Depth5() {
            ...
            final MoveStrategy minMax = new MiniMax(5);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 15833292L);
        }
        ...
        public void testPosition5Depth1() {
            ...
            final MoveStrategy minMax = new MiniMax(1);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 44L);
        }
        ...
        public void testPosition5Depth2() {
            ...
            final MoveStrategy minMax = new MiniMax(2);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 1486L);
        }
        ...
        public void testPosition5Depth3() {
            ...
            final MoveStrategy minMax = new MiniMax(3);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 62379L);
        }
        ...
        public void testPosition5Depth4() {
            ...
            final MoveStrategy minMax = new MiniMax(4);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 2103487L);
        }
        ...
        public void testPosition5Depth5() {
            ...
            final MoveStrategy minMax = new MiniMax(5);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 89941194L);
        }
        ...
        public void testPosition6Depth4() {
            ...
            final MoveStrategy minMax = new MiniMax(4);
            minMax.execute(board);
            assertEquals(((MiniMax) minMax).getNumBoardsEvaluated(), 3894594L);
        }
