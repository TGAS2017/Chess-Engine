...
//                        "Notification", JOptionPane.ERROR_MESSAGE);
            ...
            if (receivedMessage instanceof com.chess.engine.classic.board.Move) {
                final com.chess.engine.classic.board.Move m = (com.chess.engine.classic.board.Move) receivedMessage;
