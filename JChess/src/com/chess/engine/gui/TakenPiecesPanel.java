...
public class TakenPiecesPanel extends JPanel {
    ...
    public TakenPiecesPanel() {
        ...
        this.northPanel = new JPanel(new GridBagLayout(8, 2));
        this.southPanel = new JPanel(new GridBagLayout(8, 2));
    ...
    public void redo(final Table.MoveLog moveLog) {
        ...
        for (final com.chess.engine.classic.board.Move move : moveLog.getMoves()) {
            if (move.isAttack()) {
