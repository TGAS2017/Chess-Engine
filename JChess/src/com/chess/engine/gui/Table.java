...
import com.chess.pgn.MaySqlGamePersistence;
...
public final class Table extends Observable {
    ...
    private final com.chess.gui.GameHistoryPanel gameHistoryPanel;
    ...
    public Table() {
        ...
        this.gameHistoryPanel = new com.chess.gui.GameHistoryPanel();
    ...
    private com.chess.gui.GameHistoryPanel getGameHistoryPanel() {
    ...
    private static class AIThinkTank extends SwingWorker<Move, String> {
        ...
        protected Move doInBackground() throws Exception {
            ...
            final Move bookMove = Table.get().getUseBook()
                    ? MaySqlGamePersistence.get().getNextBestMove(Table.get().getGameBoard(),
    ...
    public static class MoveLog {
        ...
        private final List<com.chess.engine.classic.board.Move> moves;

        MoveLog() {
            this.moves = new ArrayList<>();
        }

        public List<com.chess.engine.classic.board.Move> getMoves() {
            return this.moves;
        }

        void addMove(final com.chess.engine.classic.board.Move move) {
            this.moves.add(move);
        }
        ...
        boolean removeMove(final com.chess.engine.classic.board.Move move) {
    ...
    private class TilePanel extends JPanel {
        ...
        TilePanel(final BoardPanel boardPanel,
            ...
            addMouseListener(new MouseListener() {
                ...
                public void mouseClicked(final MouseEvent event) {
                    ...
                    if(Table.get().getGameSetup().isAIPlayer(Table.get().getGameBoard().currentPlayer()) ||
                            com.chess.engine.classic.board.BoardUtils.isEndGame(Table.get().getGameBoard())) {
                        return;
                    }
                    ...
                    if (isRightMouseButton(event)) {
                        ...
                        if (sourceTile == null) {
                            ...
                            final com.chess.engine.classic.board.Move move = MoveFactory.createMove(chessBoard, sourceTile.getPiecePosition(),
                                    tileId);
        ...
        private void highlightLegals(final Board board) {
            if (Table.get().getHighlightLegalMoves()) {
                for (final com.chess.engine.classic.board.Move move : pieceLegalMoves(board)) {
        ...
        private Collection<com.chess.engine.classic.board.Move> pieceLegalMoves(final Board board) {
        ...
        private void assignTileColor() {
            if (com.chess.engine.classic.board.BoardUtils.INSTANCE.FIRST_ROW.get(this.tileId) ||
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.THIRD_ROW.get(this.tileId) ||
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.FIFTH_ROW.get(this.tileId) ||
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.SEVENTH_ROW.get(this.tileId)) {
                setBackground(this.tileId % 2 == 0 ? lightTileColor : darkTileColor);
            } else if(com.chess.engine.classic.board.BoardUtils.INSTANCE.SECOND_ROW.get(this.tileId) ||
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.FOURTH_ROW.get(this.tileId) ||
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.SIXTH_ROW.get(this.tileId)  ||
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.EIGHTH_ROW.get(this.tileId)) {
                setBackground(this.tileId % 2 != 0 ? lightTileColor : darkTileColor);
            }
        }
    }
