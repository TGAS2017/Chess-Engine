package com.chess.engine.classic.board;//should I get rid of classic and name it com.chess.engine.board//
...
public abstract class Move {
    ...
    public boolean equals(final Object other) {
        ...
        return getCurrentCoordinate() == otherMove.getCurrentCoordinate() && //Do I replace && with something else to remove the error//
    ...
    public Board execute() {
        ...
        builder.setMoveTransition(this);//calling this an ambiguous method. How do I fix this//
    ...
    String disambiguationFile() {
        for(final Move move : this.board.currentPlayer().getLegalMoves()) {
            if(move.getDestinationCoordinate() == this.destinationCoordinate && !this.equals(move) &&
                ...
                return com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.movedPiece.getPiecePosition()).substring(0, 1);
            }
        }
        return "";
    }
    ...
    public static class PawnPromotion extends PawnMove {
        ...
        public Board execute() {
            ...
            builder.setMoveTransition(this);//again another ambiguous error//
            return builder.build();
        }
        ...
        public String toString() {
            return com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.movedPiece.getPiecePosition()) + "-" +
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate) + "=" + this.promotionPiece.getPieceType();
        }
    ...
    public static class MajorMove extends Move {
        ...
        public String toString() {
            return movedPiece.getPieceType().toString() + disambiguationFile() +
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static class MajorAttackMove extends AttackMove {
        ...
        public MajorAttackMove(Board board, King pieceMoved, int candidateDestinationCoordinate, Piece pieceAtDestination) {
            super(board, pieceMoved, candidateDestinationCoordinate, pieceAtDestination);
        }
    ...
    public static class PawnMove extends Move {
        ...
        @Override
        public String toString() {
            return com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static class PawnAttackMove extends AttackMove {
        ...
        @Override
        public String toString() {
            return com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.movedPiece.getPiecePosition()).substring(0, 1) + "x" +
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.destinationCoordinate);
        }
    ...
    public static class PawnEnPassantAttack extends PawnAttackMove {
        ...
        public Board execute() {
            ...
            builder.setPiece(this.movedPiece.movePiece(this));
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            builder.setMoveTransition(this);//ambiguous error//
            return builder.build();
        }
    ...
    static abstract class CastleMove extends Move {
        ...
        public boolean equals(final Object other) {
            ...
            return super.equals(otherCastleMove) && this.castleRook.equals(otherCastleMove.getCastleRook());//states that && cannot be applied//
        }
    ...
    public static class KingSideCastleMove
        ...
        public KingSideCastleMove(Board board, King playerKing, int destinationCoordinate, Rook kingSideRook, int piecePosition, int castleRookDestination) {
            super(board, playerKing, destinationCoordinate, kingSideRook, piecePosition, castleRookDestination);
        }
        ...
        public boolean equals(final Object other) {
            ...
            return super.equals(otherKingSideCastleMove) && this.castleRook.equals(otherKingSideCastleMove.getCastleRook());//&& cannot be applied//
        }
    ...
    public static class QueenSideCastleMove extends CastleMove {
        ...
        public boolean equals(final Object other) {
            ...
            return super.equals(otherQueenSideCastleMove) && this.castleRook.equals(otherQueenSideCastleMove.getCastleRook());// && cannot be applied//
        }
