...
public final class WhitePlayer extends Player {
    ...
    public WhitePlayer(final Board board,
                       final Collection<com.chess.engine.classic.board.Move> whiteStandardLegals,
                       final Collection<com.chess.engine.classic.board.Move> blackStandardLegals) {
    ...
    protected Collection<Move> calculateKingCastles(final Collection<Move> playerLegals,
        ...
        final List<com.chess.engine.classic.board.Move> kingCastles = new ArrayList<>();
            ...
            if(this.board.getPiece(61) == null && this.board.getPiece(62) == null) {
                ...
                if(kingSideRook != null && kingSideRook.isFirstMove()) {
                    if(Player.calculateAttacksOnTile(61, opponentLegals).isEmpty() && Player.calculateAttacksOnTile(62, opponentLegals).isEmpty() &&
                        ...
                        if(!com.chess.engine.classic.board.BoardUtils.isKingPawnTrap(this.board, this.playerKing, 52)) {
