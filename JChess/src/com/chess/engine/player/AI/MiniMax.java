...
public final class MiniMax implements MoveStrategy {
    ...
    private static class FreqTableRow {
        ...
        @Override
        public String toString() {
            return com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.move.getCurrentCoordinate()) +
                    com.chess.engine.classic.board.BoardUtils.INSTANCE.getPositionAtCoordinate(this.move.getDestinationCoordinate()) + " : " +this.count;
        }
    }
