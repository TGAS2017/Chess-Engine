...
public class MaySqlGamePersistence implements PGNPersistence {

    private final Connection dbConnection;

    private static MaySqlGamePersistence INSTANCE = new MaySqlGamePersistence();
...
//        createMovesIndex();
    ...
    public static MaySqlGamePersistence get() {
        return INSTANCE;
    }
